...
public class FireflallayEntityModel extends SinglePartEntityModel<FireflallayEntity> implements ModelWithArms {
    ...
    public FireflallayEntityModel(ModelPart root) {
    ...
    public void setAngles(FireflallayEntity allayEntity, float f, float g, float h, float i, float j) {
